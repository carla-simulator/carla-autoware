...
class World(object):
    ...
    def destroy(self):
        ...
        if self.front_camera is not None:
            actors.append(self.front_camera.sensor)
...
# -- LidarSensor ---------------------------------------------------------------
# ==============================================================================
# Lidar sensor for handling in AD stack
...
# -- FrontCameraSensor ---------------------------------------------------------
# ==============================================================================
# Camera as Sensor for handling in AD stack
...
class FrontCamera(object):
    def __init__(self, parent_actor):
        ...
        # circular reference.
        weak_self = weakref.ref(self)
        self.sensor.listen(lambda image: FrontCamera._on_image(weak_self, image))
    ...
    def _on_image(weak_self, image):
        ...
        if not self:
            return
        # AD stack: add image handling here
...
def game_loop(args):
    ...
    try:
        ...
        world = World(client.get_world(), hud, args.filter, args.spawnpoint)
